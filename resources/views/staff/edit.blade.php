    ...
    <main class="main-content">
      ...
      <div class="form-container">
        ...
        <form action="{{ route('staff.update', $staff) }}" method="POST" enctype="multipart/form-data">
          ...
          <img
            src="{{ $staff->profile_picture ? asset('storage/' . $staff->profile_picture) : asset('images/default.jpg') }}"
            alt="profile" class="current-profile">

          <label>Change Profile Picture</label>
          <input type="file" name="profile_picture" accept="image/*">

          <button type="submit" class="staff-btn edit"><i class="fas fa-edit"></i> Update Staff</button>
        </form>
      </div>
    </main>
  </div>
